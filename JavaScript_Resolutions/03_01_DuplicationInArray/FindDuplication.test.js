...
test('排序方法解决', ()=>{
    ...
    expect(findRepeatNumber1([1, 2, 3, 4, 5, 6])).toBe(undefined)  // 是不是更好的程序 要定义没找到的字段 比如null/undefined 思路完整
...
test('哈希方法解决', ()=>{
    ...
    expect(findRepeatNumber2([1, 2, 3, 4, 5, 6])).toBe(undefined) // 找不到又变成null了
...
test('根据下标解决', ()=>{
    ...
    expect(findRepeatNumber3([1, 2, 3, 4, 5, 6])).toBe(-1)  // 找不到又变成-1了
